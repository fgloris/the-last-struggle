...
![alt text](<Screenshot from 2025-01-03 12-48-06.png>)
...
- 合并可能会产生归约-归约冲突, 如下图的I<sub>6</sub>和I<sub>9</sub>:
...
- S属性文法和L属性文法 (都属于SDD)
    ...
    - 判断是否为L属性文法: 首先区分综合属性和继承属性, 被计算的产生式左部符号的属性是综合属性.![alt text](image-18.png)
    - S属性定义的SDT实现
